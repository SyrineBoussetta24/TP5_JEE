...
<body>
	...
	<div class="container">
		<div class="card">
			<div class="card-header">Modification des types</div>
			<div class="card-body">
				<form action="updateTyp" method="post">
					<div hidden class="form-group">
						<label class="control-label">ID Type :</label> <input
					...
					<div class="form-group">
						...
						<fmt:formatDate pattern="yyyy-MM-dd"
							value="${type.dateCreation}" var="formatDate" />
